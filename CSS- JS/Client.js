function getInfo()
{
    ...
    ({
        dataType: 'json',
        url:"https://g38f06f9c3a8d07-reto1.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
        type:'GET',
        ...
        success:function(response)
        {
            var info=response.items;
                ...
                $("#dashboard").append("<th> Email </th>");
                $("#dashboard").append("<th> Age </th>");
                $("#dashboard").append("</tr>");
            ...
            for(i=0; i<response.items.length; i++)
            {
                ...
                $("#dashboard").append("<td>"+info[i].email+"</td>");
                $("#dashboard").append("<td>"+info[i].age+"</td>");
